...
//                    settings.myTimeLine.find('.item:odd').addClass('wow pull-right '+settings.RightAnimation).attr('data-wow-duration', settings.itemAnimateDuration + 's');
                    settings.myTimeLine.find('.item:even').addClass('wow '+settings.LeftAnimation).attr('data-wow-duration', settings.itemAnimateDuration + 's');
                    ...
                    settings.myTimeLine.find('.pull-right').attr('data-wow-delay', '0.3s');
//                  item.find('.title').css({backgroundColor: color});
//                  item.find('.star').css({backgroundColor: color});
					item.find('.title').css({backgroundColor: "#55AAFF"});
	                item.find('.star').css({backgroundColor: "#55AAFF"});
